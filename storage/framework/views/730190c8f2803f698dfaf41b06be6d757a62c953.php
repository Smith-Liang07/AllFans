...
<div class="col-md-12">
	<div class="footer-description">
		<div class="row" style="margin-bottom: 60px">
			...
			<a href="<?php echo e(url('/faq')); ?>" class="col-sm-2 col-2 col-lg-2 col-xs-2">FAQ</a>
			<a href="<?php echo e(url('support')); ?>" class="col-sm-2 col-2 col-lg-2 col-xs-2">Support</a>
			<a href="<?php echo e(url('termsOfUse')); ?>" class="col-sm-2 col-2 col-lg-2 col-xs-2">Terms of Use</a>
			<a href="<?php echo e(url('privacyPolicy')); ?>" class="col-sm-2 col-2 col-lg-2 col-xs-2">Privacy Policy</a>
		</div>
