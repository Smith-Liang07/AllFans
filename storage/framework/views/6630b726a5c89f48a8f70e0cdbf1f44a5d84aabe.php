        ...
        <ul class="list-inline no-margin">
          <li class="dropdown"><a href="#" class="dropdown-togle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-angle-down"></i></a>
            <ul class="dropdown-menu">
              ...
              <li class="main-link">
                <a href="#" data-toggle="modal" data-target="#shareModal"><i class="fa fa-share-alt"></i>Embed <?php echo e(trans('common.post')); ?></a>
              </li>
      ...
      <div class="text-wrapper">
        ...
        <div class="post-v-holder">
          ...
          <?php if($postImage->type=='video'): ?>
            <video width="100%" preload="none" height="auto" poster="<?php echo e(url('user/gallery/video/'.$postImage->title)); ?>" controls class="video-video-playe">
              <source src="<?php echo e(url('user/gallery/video/'.$postImage->source.'mp4')); ?>" type="video/mp4">
...
<div id="shareModal" class="modal fade" role="dialog" tabindex='-1'>
  <div class="modal-dialog">
...
<div class="modal fade" role="dialog" tabindex='-1'>
    <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div id="copy-link-content"><?php echo e(url('/share-post/'.$post->id)); ?></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(trans('common.close')); ?></button>
            </div>
