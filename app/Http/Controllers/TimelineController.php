...
//require_once('/home/fansplatformmjmd/fan/vendor/stripe/stripe-php/init.php');
...
//        echo($posts);
    ...
    public function createPost(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'post_video_upload' => 'max:50000',
        ]);

        if ($validator->fails()) {
            return response()->json(['status' => '400', 'message' => 'Video size is too large']);
        }
