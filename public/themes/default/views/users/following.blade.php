...
<div class="container">
	<div class="row">
		<div class="col-md-10">
			{!! Theme::partial('user-header',compact('timeline', 'liked_post', 'user','followRequests','following_count',
										...
										<div class="connect-list">
											...
											@if($timeline->id == Auth::user()->timeline_id)
												<div class="side-right follow-links">
													...
													<div class="left-col"><a href="#" class="btn btn-success unfollow" data-price="{{ $follow->price }}"  data-timeline-id="{{ $follow->timeline_id }}"><i class="fa fa-check"></i> {{ trans('common.following') }}</a></div>
													@endif
												</div>
											@endif
