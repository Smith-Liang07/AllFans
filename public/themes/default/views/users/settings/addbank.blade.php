					...
					<div class="panel-body nopadding">
						<div class="fans-form">
							<form  method="POST" action="{{ url('/'.$username.'/settings/save-bank-details') }}" class=".bank-details">
								...
								<div class="row">
									<div class="col-md-6">
										<fieldset class="form-group required {{ $errors->has('country') ? ' has-error' : '' }}">
											...
											{{ Form::text('country', Auth::user()->payment != NULL ? Auth::user()->country : '', array('class' => 'form-control', 'placeholder' => trans('common.country'))) }}
										</fieldset>
								...
								<div class="row">
									<div class="col-md-6">
										<fieldset class="form-group required {{ $errors->has('bank_address') ? ' has-error' : '' }}">
											{{ Form::label('bank_address', trans('Street Address')) }}
											{{ Form::text('bank_address', Auth::user()->payment != NULL ? Auth::user()->address : '', ['class' => 'form-control', 'placeholder' => trans('Street Address')]) }}
										</fieldset>
									...
									<div class="col-md-6">
										<fieldset class="form-group required {{ $errors->has('city') ? ' has-error' : '' }}">
											...
											{{ Form::text('city', Auth::user()->payment != NULL ? Auth::user()->city : '', ['class' => 'form-control', 'placeholder' => trans('City')]) }}
										</fieldset>
										@if ($errors->has('city'))
											<span class="help-block">
												{{ $errors->first('city') }}
								...
								<div class="row">
									<div class="col-md-6">
										<fieldset class="form-group required {{ $errors->has('state') ? ' has-error' : '' }}">
											...
											{{ Form::text('state', Auth::user()->payment != NULL ? Auth::user()->city : '', ['class' => 'form-control', 'placeholder' => trans('State/Province')]) }}
										</fieldset>
										@if ($errors->has('state'))
											<span class="help-block">
												{{ $errors->first('state') }}
									...
									<div class="col-md-6">
										<fieldset class="form-group required {{ $errors->has('zip') ? ' has-error' : '' }}">
											...
											{{ Form::text('zip', Auth::user()->payment != NULL ? Auth::user()->zip : '', ['class' => 'form-control', 'placeholder' => trans('Zip/Postal Code')]) }}
										</fieldset>
										@if ($errors->has('zip'))
											<span class="help-block">
												{{ $errors->first('zip') }}
								...
								<div class="row">
									<div class="col-md-10">
										<fieldset class="form-group {{ $errors->has('sell_content_confirm') ? ' has-error' : '' }}">
											...
											{{ Form::label('sell_content_confirm', trans('Yes, my account will contain explicit or adult content')) }}
										</fieldset>
