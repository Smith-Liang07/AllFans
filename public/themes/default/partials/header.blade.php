                                ...
                                @if(Setting::get('enable_browse') == 'on')
                                    ...
                                    <li class="dropdown user-image fans">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class=""><a href="{{ url('/'.Auth::user()->username.'/saved') }}"><i class="fa fa-bookmark" aria-hidden="true"></i>Saved Posts</a></li>

                                            <li class=""><a href="{{ url(Auth::user()->username.'/settings/addbank') }}"><i class="fa fa-university" aria-hidden="true"></i>Add Bank</a></li>

                                            <li class=""><a href="{{ url(Auth::user()->username.'/settings/addpayment') }}"><i class="fa fa-credit-card" aria-hidden="true"></i>Add Payment</a></li>

                                            @if (Auth::user()->is_bank_set)
                                                <li class=""><a href="{{ url(Auth::user()->payment->dashboard_url) }}"><i class="fa fa-credit-card" aria-hidden="true"></i>Dashboard</a></li>
                                            @endif

                                            <li class=""><a href="{{ url('/'.Auth::user()->username.'/settings/affliates') }}"><i class="fa fa-retweet" aria-hidden="true"></i>Referrals</a></li>

                                            <li class=""><a href="{{ url('/'.Auth::user()->username.'/#') }}"><i class="fa fa-question" aria-hidden="true"></i>Help & FAQ</a></li>

                                            <li class=""><a href="{{ url('/'.Auth::user()->username.'/#') }}"><i class="fa fa-envelope" aria-hidden="true"></i>Support</a></li>
