        ...
        <ul class="list-inline no-margin">
          <li class="dropdown"><a href="#" class="dropdown-togle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-angle-down"></i></a>
            <ul class="dropdown-menu">
              ...
              <li class="main-link">
                <a href="#" data-toggle="modal" data-target="#shareModal"><i class="fa fa-share-alt"></i>Embed {{ trans('common.post') }}</a>
              </li>
              
              <li class="main-link">
{{--                <a href="#" data-toggle="modal" data-target="#copyLinkModal"><i class="fa fa-link"></i>Copy Link</a>--}}
...
{{--                <a><img src="{{ url('user/gallery/locked.jpg') }}"  title="{{ $post->user->name }}" alt="{{ $post->user->name }}" onclick="$('#myModal').modal('show')"></a>--}}
        ...
        <div class="post-v-holder">
          ...
          @if($postImage->type=='video')
            <video width="100%" preload="none" height="auto" poster="{{ url('user/gallery/video/'.$postImage->title) }}" controls class="video-video-playe">
              <source src="{{ url('user/gallery/video/'.$postImage->source.'mp4') }}" type="video/mp4">
